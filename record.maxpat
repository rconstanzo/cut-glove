				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "recordoutput",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.75, 62.5, 55.0, 22.0 ],
					"style" : "",
					"text" : "r meters",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 113.008179, 62.5, 41.0, 22.0 ],
					"style" : "",
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 128.030273, 32.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 55.0, 96.030273, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.500061, 128.030273, 51.0, 22.0 ],
					"style" : "",
					"text" : "open, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 55.0, 166.930176, 187.0, 22.0 ],
					"style" : "",
					"text" : "sfrecord~ 2"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-33" : [ "recordoutput", "live.text", 0 ]
		}
,
		"dependency_cache" : [  ],
		"embedsnapshot" : 0,
